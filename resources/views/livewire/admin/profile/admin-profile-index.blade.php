        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r bg-[{{ $companyData->color_primary ?? '#000000' }}] p-6 text-white">
                <div class="flex items-center space-x-4">
                    <!-- Avatar -->
                    <div
                        class="w-20 h-20 bg-white rounded-full flex items-center justify-center text-[{{ $companyData->color_primary ?? '#000000' }}] text-3xl font-bold">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                            <svg class="w-5 h-5 mr-2 text-[{{ $companyData->color_primary ?? '#000000' }}]" fill="none"
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                            <svg class="w-5 h-5 mr-2 text-[{{ $companyData->color_primary ?? '#f58634' }}]" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
