    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full transform transition-all scale-95 duration-300 ease-out animate-fade-in"
        ...
        <div class="flex justify-between items-center p-6 border-b">
            <div class="flex items-center gap-2">
                ...
                <h2 class="text-xl font-semibold text-gray-800">Modal Admin</h2>
            </div>
        ...
        <div class="px-6 py-4 text-gray-600 overflow-auto" style="max-height: 500px;">
            <div class="mb-4">
                <label for="name" class="block text-sm font-medium text-gray-700">Nama Admin <span
        ...
        <div class="flex justify-end gap-2 px-6 py-4 border-t">
            ...
            <button wire:click='submit'
                class="px-4 py-2 bg-[{{ $companyData->color_primary ?? '#2b7fff' }}] hover:bg-[{{ $companyData->color_primary ?? '#2b7fff' }}] transition-colors text-white rounded-lg shadow transition">
                Simpan
            </button>
        </div>
    </div>
