    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full transform transition-all scale-95 duration-300 ease-out animate-fade-in"
        ...
        <div class="flex justify-between items-center p-6 border-b">
            <div class="flex items-center gap-2">
                ...
                <h2 class="text-xl font-semibold text-gray-800">Modal Mahasiswa</h2>
            </div>
        ...
        <div class="px-6 py-4 text-gray-600 overflow-auto" style="max-height: 500px;">
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700">Nama Mahasiswa <span
                            class="text-red-600">*</span></label>
                    <input id="name" type="name" wire:model.defer="name" placeholder="Contoh : Mahasiswa"
                ...
                <div>
                    <label for="nim" class="block text-sm font-medium text-gray-700">NIM <span
                            class="text-red-600">*</span></label>
                    <input id="nim" type="name" wire:model.defer="nim" placeholder="Contoh : 0021815665"
                        class="mt-1 form-control">
                    @error('nim')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                    @enderror
