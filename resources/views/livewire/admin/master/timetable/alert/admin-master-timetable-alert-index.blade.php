<div>
    @if(is_lemes())
        <div class="bg-white rounded-2xl border border-slate-200 p-5 mb-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="space-y-1">
                <div class="flex items-center gap-2 flex-wrap">
                    <span class="w-9 h-9 rounded-xl bg-amber-500/10 text-amber-600 flex items-center justify-center font-bold text-base border border-amber-200 shadow-xs">
                ...
                <p class="text-xs text-slate-500">Rekapitulasi log aktivitas dan pelanggaran sistem ujian peserta.</p>
            </div>
