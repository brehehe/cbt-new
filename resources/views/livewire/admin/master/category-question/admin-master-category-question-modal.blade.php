    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full transform transition-all scale-95 duration-300 ease-out animate-fade-in"
        ...
        <div class="flex justify-between items-center p-6 border-b">
            <div class="flex items-center gap-2">
                ...
                <h2 class="text-xl font-semibold text-gray-800">Modal Kategori Soal</h2>
            </div>
        ...
        <div class="px-6 py-4 text-gray-600">
            <div class="mb-4">
                <label for="name" class="block text-sm font-medium text-gray-700">Nama Kategori Soal <span
                        class="text-red-600">*</span></label>
                <input type="text" id="name" wire:model.defer="name" placeholder="Nama Kategori Soal"
            ...
            <div class="mb-4">
                <label for="description" class="block text-sm font-medium text-gray-700">Deskripsi Kategori Soal</label>
