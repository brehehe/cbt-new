<div wire:ignore.self id="modal" class="fixed inset-0 bg-overlay hidden items-center justify-center z-50 transition-opacity duration-300 ease-in-out">
    <div class="bg-white rounded-2xl shadow-2xl max-w-lg w-full transform transition-all scale-95 duration-300 ease-out animate-fade-in">
        ...
        <div class="px-6 py-4 text-gray-600">
            <div class="mb-4">
                <label for="import" class="block text-sm font-medium text-gray-700">Import Excel <span class="text-red-600">*</span></label>
                <input type="file" id="import" wire:model.defer="import" placeholder="Masukkan File Excel" class="mt-1 form-control">
                @error('import')
        ...
        <div class="flex justify-end gap-2 px-6 py-4 border-t">
            ...
            <button wire:click='saveImport' wire:loading.attr="disabled" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow transition">
                Simpan
            </button>
        </div>
    </div>
