<div wire:ignore.self id="modal" class="fixed inset-0 bg-overlay hidden items-center justify-center z-50 transition-opacity duration-300 ease-in-out">
    <div class="bg-white rounded-2xl shadow-2xl max-w-lg w-full transform transition-all scale-95 duration-300 ease-out animate-fade-in">
        ...
        <div class="px-6 py-4 text-gray-600">
            <div class="mb-4">
                <label for="data_name" class="block text-sm font-medium text-gray-700">Nama Produk <span class="text-red-600">*</span></label>
                <input type="text" id="data_name" wire:model.defer="data_name" placeholder="Masukkan nama produk" disabled class="mt-1 form-control">
                @error('data_name')
            ...
            <div class="mb-4">
                ...
                <div class="mt-1 flex rounded-md shadow-sm">
                    ...
                    <input type="text" onkeyup="convertToRupiah(this);" id="hpp_average" wire:model.defer="hpp_average" placeholder="XXXXXXXXX" class="form-control rounded-l-none" />
                </div>
                @error('hpp_average')
                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4">
                <label for="price" class="block text-sm font-medium text-gray-700">Harga Normal <span class="text-red-600">*</span></label>
                <div class="mt-1 flex rounded-md shadow-sm">
                    <span class="inline-flex items-center rounded-l-md border border-r-0 border-gray-300 bg-gray-100 px-3 text-gray-500 text-sm">
                        Rp
                    </span>
                    <input type="text" onkeyup="convertToRupiah(this);" id="price" wire:model.defer="price" placeholder="XXXXXXXXX" class="form-control rounded-l-none" />
                </div>
                @error('price')
                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            ...
            {{-- <div class="mb-4">
                <label for="recipe" class="block text-sm font-medium text-gray-700">Harga Resep <span class="text-red-600">*</span></label>
                <div class="mt-1 flex rounded-md shadow-sm">
                    <span class="inline-flex items-center rounded-l-md border border-r-0 border-gray-300 bg-gray-100 px-3 text-gray-500 text-sm">
                        Rp
                    </span>
                    <input type="text" onkeyup="convertToRupiah(this);" id="recipe" wire:model.defer="recipe" placeholder="XXXXXXXXX" class="form-control rounded-l-none" />
                </div>
                @error('recipe')
                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
