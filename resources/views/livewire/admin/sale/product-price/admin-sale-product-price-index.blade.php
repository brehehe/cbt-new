        ...
        <div class="px-5 py-4 bg-gray-50/80 border-t border-gray-200">
            <div class="flex items-center justify-between">
                <div class="text-sm text-gray-700">
                    Menampilkan <span class="font-medium">{{ $productPrices->firstItem() }}</span> sampai <span class="font-medium">{{ $productPrices->lastItem() }}</span> dari <span class="font-medium">{{ $productPrices->total() }}</span> hasil
                </div>
                <div>
