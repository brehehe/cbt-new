...
<div wire:ignore.self id="modalCash" class="fixed inset-0 bg-overlay hidden items-center justify-center z-50 transition-opacity duration-300 ease-in-out">
    <div class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full transform transition-all scale-95 duration-300 ease-out animate-fade-in">
        <!-- Header -->
        <div class="flex justify-between items-center p-6 border-b">
            <div class="flex items-center gap-4">
        ...
        <div class="px-6 py-4 text-gray-600" style="max-height: 70vh; overflow-y: auto;">
            <div class="mb-4">
                ...
                <input type="text" wire:model.lazy='description' placeholder="Deskripsi" class="mt-1 block w-full rounded-md border-gray-300 px-4 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                @error('description')
                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700">Total Cash <span class="text-red-600">*</span></label>
                <input type="text" onkeyup="convertToRupiah(this)" wire:model.lazy='amount' placeholder="Masukan Total Cash" class="mt-1 block w-full rounded-md border-gray-300 px-4 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                @error('amount')
                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="flex justify-between items-center px-6 py-4 border-t bg-gray-50">
            ...
            <div class="flex gap-4">
                ...
                <button wire:click='submitCashBank()' wire:loading.attr="disabled" wire:target="submitCashBank" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow transition">
