                ...
                <div class="mb-4">
                    ...
                    <div wire:key="select-{{ rand() }}">
                        <select class="mt-1 form-control" x-data x-ref="input" x-init="$($refs.input).selectize({
                            ...
                            wire:model.lazy="doctor_id" id="doctor_id">
                ...
                <div class="mb-4">
                    ...
                    <div wire:key="select-{{ rand() }}">
                        <select class="mt-1 form-control" x-data x-ref="input" x-init="$($refs.input).selectize({
                            ...
                            wire:model.lazy="location_id" id="location_id">
                ...
                <div class="mb-4">
                    ...
                    <div wire:key="select-{{ rand() }}">
                        <select class="mt-1 form-control" x-data x-ref="input" x-init="$($refs.input).selectize({
                            ...
                            plugins: ['clear_button'],
                            onChange: function(e) {
                                @this.set('control_doctor_id', e ? e : '');
                            }
                        });"
                            wire:model.lazy="control_doctor_id" id="control_doctor_id">
                            <option value="">-- Pilih Jadwal Dokter --</option>
                            @foreach ($controlDoctors as $controlDoctor)
                                <option value="{{ $controlDoctor['id'] }}">{{ $controlDoctor['day'] }}:
