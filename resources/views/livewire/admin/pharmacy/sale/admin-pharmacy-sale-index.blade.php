<div>
    @include('livewire.admin.pharmacy.sale.admin-pharmacy-sale-modal')
    <div class="mb-4">
        <div class="flex items-center justify-between">
            ...
            <div>
                <button class="btn btn-primary" wire:click="openModal">
                    <i class="fa-solid fa-plus mr-2"></i> Tambah Penjualan
                </button>
            </div>
        </div>
    </div>
        ...
        $transaction->date
            ...
            : '-'
                            ...
                            <td>
                                ...
                                @elseif (in_array($transaction->status, ['sale_pharmacy']))
                            ...
                            <td class="center">
                                <div class="flex items-center">
                                    @if (in_array($transaction->status, ['sale_pharmacy']))
                                    ...
                                    @else
                                        <button class="btn btn-icon text-blue-600 hover:text-blue-800 transition-colors edit-btn" wire:click="confirmDetail('{{ $transaction->id }}')">
