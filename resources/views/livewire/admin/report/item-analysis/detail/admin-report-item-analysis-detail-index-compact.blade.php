...
<div>
    ...
    <div class="mb-3 bg-white rounded-lg p-3 shadow-sm">
        <div class="flex justify-between items-center">
            <div>
                <h1
                    class="text-lg font-bold {{ in_array(config('app.name_slug'), ['ups_tegal', 'unimma','unidayan']) ? 'text-[#2b7fff]' : 'text-[#f58634]' }} mb-1">
                        ...
                        <tr class="border-b">
                            ...
                            <td class="text-xs">
                                ...
                                @elseif($analysis['difficulty_index'] > 0.7)
                                    <span
                                        class="{{ in_array(config('app.name_slug'), ['ups_tegal', 'unimma','unidayan']) ? 'text-blue-600' : 'text-orange-600' }}">Persulit</span>
                                @else
