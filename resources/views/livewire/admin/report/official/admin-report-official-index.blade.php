@section('title', 'Laporan Berita Acara Ujian')
<div>
    {{-- Be like water. --}}
    <div class="mb-4">
                ...
                <tbody>
                    @forelse ($timetables as $index => $timetable)
                        <tr>
                            ...
                            <td class="center">
                                <button wire:click="printOfficialReport('{{ $timetable->id }}')"
                                    class="btn btn-sm btn-primary">
                                    <i class="bi bi-printer me-2"></i> Cetak Berita Acara
                                </button>
                            </td>
                        </tr>
                    @empty
