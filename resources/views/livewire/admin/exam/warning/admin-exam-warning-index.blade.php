        ...
        <div class="w-full max-w-3xl p-8 bg-white shadow-sm rounded-xl">
            ...
            <div class="space-y-6">
                <div class="p-4 rounded-lg bg-orange-50">
                    <h2
                        class="mb-2 font-semibold {{ in_array(config('app.name_slug'), ['ups_tegal', 'unimma','unidayan']) ? 'text-blue-800' : 'text-orange-800' }}">
                        Informasi Ujian</h2>
                    <div
                        class="grid grid-cols-2 gap-4 text-sm {{ in_array(config('app.name_slug'), ['ups_tegal', 'unimma','unidayan']) ? 'text-blue-700' : 'text-orange-700' }}">
                        <div>
                ...
                <div class="flex justify-center mt-8">
                    <button id="startExam" disabled wire:click="confirmStartUjian()"
                        class="px-6 py-3 font-medium text-white transition-colors {{ in_array(config('app.name_slug'), ['ups_tegal', 'unimma','unidayan']) ? 'bg-[#2b7fff]' : 'bg-[#f58634]' }} rounded-lg hover:{{ in_array(config('app.name_slug'), ['ups_tegal', 'unimma','unidayan']) ? 'bg-[#2b7fff]' : 'bg-[#f58634]' }} disabled:bg-gray-300 disabled:cursor-not-allowed">
                        Mulai Ujian
                    </button>
                </div>
            </div>
