        ...
        <div class="w-full max-w-3xl p-8 bg-white shadow-sm rounded-xl">
            ...
            <div class="space-y-6">
                <div class="p-4 rounded-lg bg-orange-50">
                    <h2
                        class="mb-2 font-semibold text-[{{ $companyData->color_primary ?? '#2b7fff' }}]">
                        Informasi Ujian</h2>
                    <div
                        class="grid grid-cols-2 gap-4 text-sm text-[{{ $companyData->color_primary ?? '#2b7fff' }}]">
                        <div>
                ...
                <div class="flex justify-center mt-8">
                    <button id="startExam" disabled wire:click="confirmStartUjian()"
                        class="px-6 py-3 font-medium text-white transition-colors bg-[{{ $companyData->color_primary ?? '#2b7fff' }}] hover:bg-[{{ $companyData->color_primary ?? '#2b7fff' }}] rounded-lg hover:bg-[{{ $companyData->color_primary ?? '#2b7fff' }}] disabled:bg-gray-300 disabled:cursor-not-allowed">
                        Mulai Ujian
                    </button>
                </div>
            </div>
