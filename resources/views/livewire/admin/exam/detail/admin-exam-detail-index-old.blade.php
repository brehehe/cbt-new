                    ...
                    <div class="flex">
                        @if ($first)
                            <button wire:click='previousQuestion()' type="button"
                                class="flex items-center px-4 py-2 {{ in_array(config('app.name_slug'), ['ups_tegal', 'unimma','unidayan']) ? 'text-blue-600' : 'text-orange-600' }} transition-colors hover:{{ in_array(config('app.name_slug'), ['ups_tegal', 'unimma','unidayan']) ? 'text-blue-700' : '{{ in_array(config('app.name_slug'), ['ups_tegal', 'unimma','unidayan']) ? 'text-blue-700' : 'text-orange-700' }}' }}">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15 19l-7-7 7-7" />
                                </svg>
        ...
        <div id="rightSidebar"
            ...
            <div class="p-4 border-b border-gray-200 bg-orange-50">
                <div class="text-center">
                    <div
                        class="flex items-center justify-center w-16 h-16 mx-auto mb-3 bg-primary
            ...
            <div x-data="{ showCamera: true }" class="p-4 border-b border-gray-200">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <button @click="showCamera = !showCamera"
                        class="px-2 py-1 text-xs text-white bg-primary hover:bg-primary rounded">
