                    ...
                    <div class="flex">
                        @if ($first)
                            <button wire:click='previousQuestion()' type="button"
                                class="flex items-center px-4 py-2 {{ in_array(config('app.name_slug'), ['ups_tegal', 'unimma']) ? 'text-blue-600' : 'text-orange-600' }} transition-colors hover:{{ in_array(config('app.name_slug'), ['ups_tegal', 'unimma']) ? 'text-blue-700' : '{{ in_array(config('app.name_slug'), ['ups_tegal', 'unimma']) ? 'text-blue-700' : 'text-orange-700' }}' }}">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15 19l-7-7 7-7" />
                                </svg>
