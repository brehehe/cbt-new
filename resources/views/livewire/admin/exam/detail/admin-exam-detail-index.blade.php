<div id="exam-container">
    ...
    <header
        class="p-2 text-white {{ config('app.name_slug') === 'ups_tegal' ? 'bg-blue-600' : 'bg-orange-600' }} shadow-lg sm:p-4">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-4">
                <h1 class="text-lg font-bold sm:text-xl">Computer Based Test</h1>
                <div
                    class="px-2 py-1 {{ config('app.name_slug') === 'ups_tegal' ? 'bg-blue-600' : 'bg-orange-600' }} rounded sm:px-3">
