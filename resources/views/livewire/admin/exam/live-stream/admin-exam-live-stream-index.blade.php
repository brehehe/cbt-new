                    ...
                    <div class="p-6">
                        <div class="relative bg-black rounded-lg aspect-video">
                            ...
                            <div class="absolute top-4 right-4 flex space-x-2">
                                <button wire:click="openMessageModal('{{ $selectedSession->id }}')"
                                    class="px-3 py-1 bg-blue-600 bg-opacity-80 text-white text-sm rounded hover:bg-opacity-100 flex items-center space-x-1 shadow transition">
                                    <span>💬</span> <span>Kirim Pesan</span>
                                </button>
                                ...
                                <div class="relative bg-black aspect-video">
                                    ...
                                    <div class="absolute top-2 right-2 flex space-x-1">
                                        <button wire:click="openMessageModal('{{ $session->id }}')"
                                            class="p-1 bg-blue-600 bg-opacity-80 text-white text-xs rounded hover:bg-opacity-100 transition shadow" title="Kirim Peringatan">
                                            💬
                                        </button>
                            ...
                            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                                ...
                                <div class="relative bg-black aspect-video">
                                    ...
                                    <div class="absolute top-3 right-3 flex space-x-2">
                                        <button wire:click="openMessageModal('{{ $session->id }}')"
                                            class="px-2 py-1 bg-blue-600 bg-opacity-80 text-white text-xs rounded hover:bg-opacity-100 transition shadow flex items-center space-x-1" title="Kirim Peringatan">
                                            <span>💬 Pesan</span>
                                        </button>
                                        <button wire:click="takeSnapshot('{{ $session->id }}')"
