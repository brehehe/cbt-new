...
<div>
    ...
    <div class="mb-8 relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-8 text-white shadow-2xl">
        ...
        <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="text-center md:text-left">
                <h1 class="text-3xl md:text-4xl font-black tracking-tight drop-shadow-sm">
                    Hola, {{ Auth::user()->name ?? 'Admin' }}! 👋
                </h1>
                <p class="text-indigo-100 mt-2 text-sm md:text-base font-medium">Siap pantau ujian hari ini? Let's go! 🚀</p>
            </div>
    ...
    @if (!Auth::user()->hasRole('Mahasiswa'))
        <!-- Main Stats Overview (Gen Z Style) -->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <!-- Total Users Card -->
            <div class="group relative overflow-hidden bg-white/70 backdrop-blur-xl rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white hover:shadow-[0_20px_40px_rgba(99,102,241,0.1)] transition-all duration-300 hover:-translate-y-1">
                <div class="absolute top-0 right-0 w-32 h-32 bg-blue-100 rounded-full blur-3xl opacity-50 group-hover:bg-blue-200 transition-colors"></div>
                <div class="relative flex items-center justify-between">
                    <div>
                        ...
                        <div class="flex items-center mt-3">
                            <span class="text-xs font-bold text-blue-600 bg-blue-100/50 px-3 py-1.5 rounded-xl backdrop-blur-sm">
                    ...
                    <div class="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-2xl shadow-lg shadow-blue-500/30 text-white transform group-hover:scale-110 transition-transform duration-300">
            ...
            <!-- Active Exams Card -->
            <div class="group relative overflow-hidden bg-white/70 backdrop-blur-xl rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white hover:shadow-[0_20px_40px_rgba(245,158,11,0.1)] transition-all duration-300 hover:-translate-y-1">
                <div class="absolute top-0 right-0 w-32 h-32 bg-amber-100 rounded-full blur-3xl opacity-50 group-hover:bg-amber-200 transition-colors"></div>
                <div class="relative flex items-center justify-between">
                    <div>
                        <p class="text-sm font-bold text-slate-400 uppercase tracking-wider mb-1">Active Exams 🔥</p>
                        <h3 class="text-4xl font-black text-slate-800">
                            {{ number_format($activeExams) }}
                        </h3>
                        <div class="flex items-center mt-3">
                            <span class="text-xs font-bold text-amber-600 bg-amber-100/50 px-3 py-1.5 rounded-xl backdrop-blur-sm">
                                🚀 Ujian sedang jalan
                            </span>
                        </div>
                    </div>
                    <div class="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-amber-400 to-orange-500 rounded-2xl shadow-lg shadow-amber-500/30 text-white transform group-hover:scale-110 transition-transform duration-300">
            ...
            <!-- Today's Exams Card -->
            <div class="group relative overflow-hidden bg-white/70 backdrop-blur-xl rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white hover:shadow-[0_20px_40px_rgba(16,185,129,0.1)] transition-all duration-300 hover:-translate-y-1">
                <div class="absolute top-0 right-0 w-32 h-32 bg-emerald-100 rounded-full blur-3xl opacity-50 group-hover:bg-emerald-200 transition-colors"></div>
                <div class="relative flex items-center justify-between">
                    <div>
                        <p class="text-sm font-bold text-slate-400 uppercase tracking-wider mb-1">Today's Exams 📅</p>
                        <h3 class="text-4xl font-black text-slate-800">
                            {{ number_format($todayExams) }}
                        </h3>
                        <div class="flex items-center mt-3">
                            <span class="text-xs font-bold text-emerald-600 bg-emerald-100/50 px-3 py-1.5 rounded-xl backdrop-blur-sm">
                                ✅ {{ number_format($completedExams) }} Selesai
                            </span>
                        </div>
                    </div>
                    <div class="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-2xl shadow-lg shadow-emerald-500/30 text-white transform group-hover:scale-110 transition-transform duration-300">
            ...
            <!-- Exam Alerts Card -->
            <div class="group relative overflow-hidden bg-white/70 backdrop-blur-xl rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white hover:shadow-[0_20px_40px_rgba(239,68,68,0.1)] transition-all duration-300 hover:-translate-y-1">
                <div class="absolute top-0 right-0 w-32 h-32 bg-red-100 rounded-full blur-3xl opacity-50 group-hover:bg-red-200 transition-colors"></div>
                <div class="relative flex items-center justify-between">
                    <div>
                        <p class="text-sm font-bold text-slate-400 uppercase tracking-wider mb-1">Security Alerts 🚨</p>
                        <h3 class="text-4xl font-black text-slate-800">
                            {{ $examAlerts }}
                        </h3>
                        <div class="flex items-center mt-3">
                            <span class="text-xs font-bold {{ $examAlerts > 0 ? 'text-red-600 bg-red-100/50' : 'text-green-600 bg-green-100/50' }} px-3 py-1.5 rounded-xl backdrop-blur-sm flex items-center gap-2">
                                @if ($examAlerts > 0)
                                    <span class="w-2 h-2 rounded-full bg-red-500 animate-pulse"></span> Pelanggaran
                                @else
                                    <span class="w-2 h-2 rounded-full bg-green-500"></span> Aman Sentosa
                                @endif
                            </span>
                        </div>
                    </div>
                    <div class="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-red-400 to-rose-500 rounded-2xl shadow-lg shadow-red-500/30 text-white transform group-hover:scale-110 transition-transform duration-300">
        ...
        <!-- Secondary Stats Grid (Gen Z Style) -->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <!-- Completed Exams -->
            <div class="group bg-white/70 backdrop-blur-xl rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white hover:shadow-[0_20px_40px_rgba(16,185,129,0.1)] transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center justify-between mb-4">
                    <div class="bg-gradient-to-br from-emerald-100 to-green-200 p-3.5 rounded-2xl shadow-inner group-hover:scale-110 transition-transform duration-300">
                        <i class="fa-solid fa-check-double text-emerald-600 text-xl"></i>
                    </div>
                    <span class="text-3xl font-black text-emerald-600 drop-shadow-sm">{{ number_format($completedExams) }}</span>
                </div>
                <p class="text-sm font-bold text-slate-500 uppercase tracking-wider">Ujian Selesai</p>
                @if (isset($monthlyStats['completed_this_month']))
                    <p class="text-xs font-bold text-emerald-500 mt-2 bg-emerald-50 inline-block px-2.5 py-1 rounded-xl">
                        ✨ {{ $monthlyStats['completed_this_month'] }} bulan ini
                    </p>
                @endif
            </div>

            <!-- Total Exam Types -->
            <div class="group bg-white/70 backdrop-blur-xl rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white hover:shadow-[0_20px_40px_rgba(168,85,247,0.1)] transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center justify-between mb-4">
                    <div class="bg-gradient-to-br from-purple-100 to-fuchsia-200 p-3.5 rounded-2xl shadow-inner group-hover:scale-110 transition-transform duration-300">
                        <i class="fa-solid fa-layer-group text-purple-600 text-xl"></i>
                    </div>
                    <span class="text-3xl font-black text-purple-600 drop-shadow-sm">{{ number_format($totalExamTypes) }}</span>
                </div>
                <p class="text-sm font-bold text-slate-500 uppercase tracking-wider">Kategori Ujian</p>
                <p class="text-xs font-bold text-purple-500 mt-2 bg-purple-50 inline-block px-2.5 py-1 rounded-xl">
                    📚 Jenis tersedia
                </p>
            </div>

            <!-- Completion Rate -->
            <div class="group bg-white/70 backdrop-blur-xl rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white hover:shadow-[0_20px_40px_rgba(99,102,241,0.1)] transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center justify-between mb-4">
                    <div class="bg-gradient-to-br from-indigo-100 to-blue-200 p-3.5 rounded-2xl shadow-inner group-hover:scale-110 transition-transform duration-300">
                        <i class="fa-solid fa-chart-line text-indigo-600 text-xl"></i>
                    </div>
                    <span class="text-3xl font-black text-indigo-600 drop-shadow-sm">
                ...
                <p class="text-sm font-bold text-slate-500 uppercase tracking-wider">Completion Rate</p>
                <p class="text-xs font-bold text-indigo-500 mt-2 bg-indigo-50 inline-block px-2.5 py-1 rounded-xl">
                    📈 Rata-rata bulan ini
                </p>
            </div>

            <!-- Live Sessions -->
            <div class="group bg-white/70 backdrop-blur-xl rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white hover:shadow-[0_20px_40px_rgba(234,179,8,0.1)] transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center justify-between mb-4">
                    <div class="bg-gradient-to-br from-yellow-100 to-amber-200 p-3.5 rounded-2xl shadow-inner group-hover:scale-110 transition-transform duration-300">
                        <i class="fa-solid fa-satellite-dish text-yellow-600 text-xl"></i>
                    </div>
                    <span class="text-3xl font-black text-yellow-600 drop-shadow-sm">
                ...
                <p class="text-sm font-bold text-slate-500 uppercase tracking-wider">Sesi Langsung</p>
                <div class="flex items-center mt-2 bg-yellow-50 inline-block px-2.5 py-1 rounded-xl w-max">
                    <div class="flex items-center gap-2">
                        <span class="relative flex h-2 w-2">
                            <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-yellow-400 opacity-75"></span>
                            <span class="relative inline-flex rounded-full h-2 w-2 bg-yellow-500"></span>
                        </span>
                        <span class="text-xs font-bold text-yellow-600">Aktif sekarang</span>
                    </div>
                </div>
            </div>
        </div>
