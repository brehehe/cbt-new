            ...
            <div class="relative flex h-screen">
                ...
                <div class="group relative hidden w-0 overflow-hidden lg:block lg:w-3/5">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-br from-green-600 via-green-700 to-green-900 transition-all duration-1000 hover:from-green-500 hover:via-green-600 hover:to-green-800"
                        style="clip-path: polygon(0 0, 100% 0, 85% 100%, 0 100%); background-image: url('{{ asset('asset/img/ikmb-dark.png') }}'); background-size: cover; background-position: center;">
                    </div>
                    ...
                    <div class="relative z-10 flex h-full flex-col p-6 text-white xl:p-12">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="group/brand flex items-center space-x-3">
                                <div class="relative">
                                    <div
                                        class="flex h-16 w-16 cursor-pointer items-center justify-center rounded-full border border-white/30 bg-white/20 p-1.5 backdrop-blur-sm transition-all duration-500 hover:rotate-6 hover:scale-110 hover:bg-white/30">
            ...
            <div class="relative flex h-screen">
                ...
                <div class="group relative hidden w-0 overflow-hidden lg:block lg:w-3/5">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 transition-all duration-1000 hover:from-blue-500 hover:via-blue-600 hover:to-blue-800"
                        style="clip-path: polygon(0 0, 100% 0, 85% 100%, 0 100%); background-image: url('{{ asset('asset/img/unimma-background.jpeg') }}'); background-size: cover; background-position: center;">
                    </div>
                            ...
                            <div class="group/brand flex items-center space-x-3">
                                <div class="relative">
                                    <img alt="Logo" class="object-contain" style="width: 215px;" loading="lazy"
                                        src="{{ asset('asset/img/unimma-removebg-preview.png') }}">
                                </div>
                            </div>
                                ...
                                <div class="mb-6 text-center lg:mb-8">
                                    <div class="relative mb-4 inline-block lg:mb-6">
                                        <div
                                            ...
                                            <img src="{{ asset('asset/img/logo-unimma.webp') }}" alt="">
                                        </div>
                                    </div>
        ...
        <div class="relative h-screen overflow-hidden bg-[#dce0f4]">
            ...
            <div class="relative flex h-screen">
                ...
                <div class="group relative hidden w-0 overflow-hidden lg:block lg:w-3/5">
                    <!-- Background with modern clip-path -->
                    <div class="absolute inset-0 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 transition-all duration-1000 hover:from-blue-500 hover:via-blue-600 hover:to-blue-800"
                        style="clip-path: polygon(0 0, 100% 0, 85% 100%, 0 100%); background-image: url('{{ asset('asset/img/background-auth-ups.jpeg') }}'); background-size: cover; background-position: center;">
                    </div>
                                ...
                                <div class="mb-6 text-center lg:mb-8">
                                    <div class="relative mb-4 inline-block lg:mb-6">
                                        <div
                                            ...
                                            <img src="{{ asset('asset/img/logo-ups-potrait.png') }}" alt="">
                                        </div>
                                    </div>
