...
@section('content')
    <div class="min-h-screen p-6 bg-gradient-to-br from-[#F8FAFC] to-[#C3D4EC]/20">
        <!-- Welcome Section -->
        <div class="mb-4">
            <h1 class="text-2xl font-bold text-[#f58634]">Welcome back, Admin User!</h1>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-[#f58634]">2,451</h3>
                        <p class="text-xs text-green-600">+12.5% from last month</p>
                    </div>
                    <div class="bg-[#C3D4EC]/20 p-3 rounded-lg">
                        <svg class="w-6 h-6 text-[#f58634]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-[#f58634]">28</h3>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-[#f58634]">12</h3>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-[#f58634]">Rp 8.5M</h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100">
                <div class="p-4 border-b border-gray-100">
                    <h2 class="text-lg font-semibold text-[#f58634]">Upcoming Appointments</h2>
                </div>
                <div class="p-4">
                    <div class="space-y-4">
                        <!-- Appointment 1 -->
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center space-x-3">
                                <div class="bg-[#C3D4EC] rounded-full p-2">
                                    <svg class="w-4 h-4 text-[#f58634]" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="text-right">
                                <p class="text-sm font-medium text-[#f58634]">09:30 AM</p>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            ...
                            <div class="text-right">
                                <p class="text-sm font-medium text-[#f58634]">10:15 AM</p>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            ...
                            <div class="text-right">
                                <p class="text-sm font-medium text-[#f58634]">11:00 AM</p>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            ...
                            <div class="text-right">
                                <p class="text-sm font-medium text-[#f58634]">01:30 PM</p>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            ...
                            <div class="text-right">
                                <p class="text-sm font-medium text-[#f58634]">02:45 PM</p>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 p-4">
                    <h2 class="text-lg font-semibold text-[#f58634] mb-4">Quick Actions</h2>
                    <div class="grid grid-cols-2 gap-3">
                        <button
                            class="p-3 bg-[#C3D4EC]/20 rounded-lg text-[#f58634] hover:bg-[#C3D4EC]/40 transition-colors">
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 p-4">
                    <h2 class="text-lg font-semibold text-[#f58634] mb-4">Recent Notifications</h2>
                    <div class="space-y-3">
                        <!-- Notification 1 -->
