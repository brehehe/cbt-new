            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-[#C3D4EC]/20 p-3 rounded-lg">
                        <svg class="w-6 h-6 {{ config('app.name_slug') === 'ups_tegal' ? 'text-[#2b7fff]' : 'text-[#f58634]' }}"
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3
                            ...
                            12</h3>
                        <p
                            class="text-xs {{ config('app.name_slug') === 'ups_tegal' ? 'text-blue-600' : 'text-orange-600' }}">
                            3 on leave today</p>
                    </div>
                    <div class="bg-[#C3D4EC]/20 p-3 rounded-lg">
                        <svg class="w-6 h-6 {{ config('app.name_slug') === 'ups_tegal' ? 'text-[#2b7fff]' : 'text-[#f58634]' }}"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100">
                <div class="p-4 border-b border-gray-100">
                    <h2
                        class="text-lg font-semibold {{ config('app.name_slug') === 'ups_tegal' ? 'text-[#2b7fff]' : 'text-[#f58634]' }}">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center space-x-3">
                                <div class="bg-[#C3D4EC] rounded-full p-2">
                                    <svg class="w-4 h-4 {{ config('app.name_slug') === 'ups_tegal' ? 'text-[#2b7fff]' : 'text-[#f58634]' }}"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="text-right">
                                <p
                                    class="text-sm font-medium {{ config('app.name_slug') === 'ups_tegal' ? 'text-[#2b7fff]' : 'text-[#f58634]' }}">
                                    09:30 AM</p>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 p-4">
                    <h2
                        class="text-lg font-semibold {{ config('app.name_slug') === 'ups_tegal' ? 'text-[#2b7fff]' : 'text-[#f58634]' }} mb-4">
                        Quick Actions</h2>
                    <div class="grid grid-cols-2 gap-3">
                        <button
                            class="p-3 bg-[#C3D4EC]/20 rounded-lg {{ config('app.name_slug') === 'ups_tegal' ? 'text-[#2b7fff]' : 'text-[#f58634]' }} hover:bg-[#C3D4EC]/40 transition-colors">
