        ...
        <div class="min-h-screen flex items-center justify-center p-4">
            <div
                ...
                <div class="flex flex-col items-center mb-6">
                    ...
                    <h1 class="text-2xl font-bold text-[#3BA172]">Welcome Back!</h1>
                        ...
                        <div class="flex gap-3">
                            ...
                            <div
                                ...
                                <div class="w-full h-full bg-white rounded-xl flex items-center justify-center">
                                    <span class="text-[#3BA172] font-bold tracking-wider">ABC123</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center">
                            <input type="checkbox" name="remember"
                                class="rounded border-gray-300 text-[#3BA172] focus:ring-[#1E3A8A]/20">
                            <span class="ml-2 text-sm text-gray-600">Remember me</span>
                        </label>
                        <a href="#" class="text-sm text-[#3BA172] hover:text-[#2563EB] transition-colors">Forgot
                            password?</a>
                    </div>
