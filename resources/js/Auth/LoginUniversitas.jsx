...
export default function LoginUniversitas({
    ...
    return (
        <div className="relative min-h-screen lg:h-screen w-full overflow-x-hidden lg:overflow-hidden bg-[#dce0f4] font-sans selection:bg-[var(--primary)] selection:text-white">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                ...
                <div className="absolute left-20 top-20 h-4 w-4 animate-bounce rounded-full bg-[var(--primary)]/40 blur-[1px] transition-all duration-500 hover:scale-150 hover:bg-[var(--primary)]" />
                <div 
                    className="absolute right-24 top-1/3 h-8 w-2 animate-pulse bg-[var(--secondary)]/40 rounded transition-all duration-500 hover:h-16 hover:bg-[var(--secondary)]"
                    style={{ animationDuration: '4s' }}
                />
                <div 
                    className="absolute bottom-1/4 left-1/4 h-5 w-5 rotate-45 animate-spin bg-[var(--primary)]/40 transition-all duration-1000 hover:scale-125 hover:bg-[var(--primary)]"
                    style={{ animationDuration: '15s' }}
                />
                <div className="absolute bottom-20 right-20 h-1.5 w-12 animate-pulse bg-[var(--primary)]/40 rounded transition-all duration-500 hover:w-20 hover:bg-[var(--primary)]" />
            </div>

            {/* Main Flex Layout Container */}
            <div className="relative z-10 flex min-h-screen lg:h-full w-full">
                
                {/* Left Side: Dynamic Company Showcase Panel (Hidden on Mobile) */}
                <div className="group relative hidden h-full overflow-hidden lg:block lg:w-[56%] xl:w-[58%]">
                ...
                <div className="relative flex min-h-screen lg:h-full w-full flex-col overflow-y-auto px-4 py-4 sm:px-6 lg:w-[44%] xl:w-[42%] lg:px-8 xl:px-12">
                    
                    {/* Header bar visible ONLY on mobile screens */}
                    <div className="mb-4 lg:hidden">
                        <div className="inline-flex items-center space-x-2.5 rounded-2xl border border-white/40 bg-white/80 px-3.5 py-1.5 shadow-md backdrop-blur-xl">
                            <div 
                                style={{ backgroundColor: 'var(--primary)' }}
                                className="flex h-7 w-7 items-center justify-center rounded-lg shadow-sm opacity-90"
                            >
                    ...
                    {/* Glassmorphic Login Card & Footer Wrapper (m-auto handles vertical centering and prevents scroll-clipping) */}
                    <div className="m-auto w-full max-w-md py-2 sm:py-4">
                        <div className="relative">
                            {/* Colorful background neon blur behind the card */}
                            <div className="absolute -inset-1 rounded-[1.75rem] bg-gradient-to-r from-[var(--primary)]/20 via-[var(--secondary)]/10 to-transparent opacity-70 blur-xl filter" />

                            {/* Main Card Element */}
                            <div className="relative rounded-[1.75rem] border border-white/60 bg-white/92 p-5 sm:p-6 lg:p-6 shadow-[0_15px_35px_rgba(0,0,0,0.06)] backdrop-blur-2xl transition-all duration-300 hover:shadow-[0_20px_45px_rgba(59,130,246,0.1)]">
                                
                                {/* Card Title / Branding */}
                                <div className="mb-4 text-center">
                                    <div className="relative inline-block transition-transform duration-300 hover:scale-105 mb-1">
                                        <img 
                                            src={company.logo_potrait ? `/storage/${company.logo_potrait}` : '/asset/img/logo-procbt.png'} 
                                            className="h-12 sm:h-14 w-auto max-w-[150px] object-contain filter drop-shadow-[0_2px_4px_rgba(0,0,0,0.05)]" 
                                            alt="Logo Portrait" 
                                        />
                                    </div>
                                ...
                                {activeSession && (
                                    <div className="mb-4 animate-fadeIn rounded-2xl border border-red-100 bg-red-50/75 p-3.5 shadow-sm backdrop-blur-sm">
                                        <div className="flex items-start">
                                            <div className="flex-shrink-0 mt-0.5">
                                                <svg className="h-4.5 w-4.5 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                {errorMsg && (
                                    <div className="mb-4 rounded-xl border border-amber-200 bg-amber-50 p-3 text-xs font-semibold text-amber-900 shadow-sm flex items-center gap-2 animate-pulse">
                                        <svg className="h-4 w-4 text-amber-600 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                ...
                                <form onSubmit={handleLoginSubmit} className="space-y-3.5">
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-[11px] font-bold text-gray-700 tracking-wide uppercase">Username / Email / NIM</label>
                                        <div className="relative group">
                                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 group-focus-within:text-[var(--primary)] transition-colors duration-200">
                                            ...
                                            <input 
                                                ...
                                                className="block w-full rounded-xl border border-gray-200 bg-gray-50/50 py-2.5 sm:py-3 pl-10 pr-4 text-sm font-medium text-gray-800 placeholder-gray-400 shadow-inner outline-none transition-all duration-200 hover:border-gray-300 focus:border-[var(--primary)] focus:bg-white focus:ring-3 focus:ring-[var(--primary)]/10 disabled:opacity-50"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-[11px] font-bold text-gray-700 tracking-wide uppercase">Password</label>
                                        <div className="relative group">
                                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 group-focus-within:text-[var(--primary)] transition-colors duration-200">
                                                <svg className="h-4.5 w-4.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                            ...
                                            <input 
                                                ...
                                                className="block w-full rounded-xl border border-gray-200 bg-gray-50/50 py-2.5 sm:py-3 pl-10 pr-10 text-sm font-medium text-gray-800 placeholder-gray-400 shadow-inner outline-none transition-all duration-200 hover:border-gray-300 focus:border-[var(--primary)] focus:bg-white focus:ring-3 focus:ring-[var(--primary)]/10 disabled:opacity-50"
                                            />
                                    ...
                                    <div className="flex items-center justify-between pt-0.5">
                                        <label className="flex items-center gap-2 cursor-pointer group">
                                            <input 
                                                ...
                                                className="h-4 w-4 rounded border-gray-300 text-[var(--primary)] outline-none focus:ring-0 cursor-pointer" 
                                            />
                                    ...
                                    <div className="pt-1">
                                        <button 
                                            ...
                                            disabled={loading}
                                            style={{ backgroundColor: 'var(--primary)' }}
                                            className="group relative flex w-full items-center justify-center gap-2 rounded-xl py-2.5 sm:py-3 px-4 text-sm font-bold text-white shadow-lg hover:brightness-95 active:scale-[0.98] transition-all disabled:opacity-80 cursor-pointer"
                                        >
                                            {loading ? (
                                            ...
                                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5">
                                                {Object.keys(credentials).map((role) => (
                                                    <button 
                                                        ...
                                                        className="flex w-full items-center justify-center rounded-lg border border-gray-200/80 bg-gray-50/80 px-2 py-1.5 text-[11px] sm:text-xs font-semibold text-gray-600 hover:text-[var(--primary)] hover:border-[var(--primary)]/30 hover:bg-[var(--primary)]/5 active:scale-95 transition-all duration-150 capitalize cursor-pointer"
                                                    >
                                                        {role}
                                                    </button>
                                                ))}
                                ...
                                {(appWindows || appMac || appAndroid || appIos) && (
                                    <div className="mt-4 border-t border-gray-100 pt-3">
                                        <h3 className="text-[10px] font-bold text-gray-400 text-center mb-2 uppercase tracking-wider">
                                            Download Aplikasi
                                        </h3>
                                        <div className="flex justify-center flex-wrap gap-1.5">
                                            {appWindows && (
                                                <a 
                                                    href={appWindows}
                                                    className="flex items-center gap-1.5 px-2.5 py-1.5 bg-[var(--primary)]/5 text-[var(--primary)] hover:bg-[var(--primary)]/10 rounded-lg text-xs font-bold transition-all hover:scale-105"
                                                >
                                            ...
                                            {appMac && (
                                                <a 
                                                    href={appMac}
                                                    className="flex items-center gap-1.5 px-2.5 py-1.5 bg-slate-50 text-slate-700 hover:bg-slate-100 rounded-lg text-xs font-bold transition-all hover:scale-105"
                                                >
                                                    <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                                    </svg>
                                            ...
                                            {appAndroid && (
                                                <a 
                                                    href={appAndroid}
                                                    className="flex items-center gap-1.5 px-2.5 py-1.5 bg-green-50 text-green-700 hover:bg-green-100 rounded-lg text-xs font-bold transition-all hover:scale-105"
                                                >
                                            ...
                                            {appIos && (
                                                <a 
                                                    href={appIos}
                                                    className="flex items-center gap-1.5 px-2.5 py-1.5 bg-slate-100 text-slate-800 hover:bg-slate-200 rounded-lg text-xs font-bold transition-all hover:scale-105"
                                                >
                                                    <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="mt-3.5 space-y-2 text-center">
                            ...
                            <div className="flex justify-center">
                                <div className="inline-flex items-center gap-3 rounded-full border border-white/50 bg-white/75 px-3.5 py-1.5 shadow-sm backdrop-blur-md transition-all duration-300 hover:bg-white/90">
