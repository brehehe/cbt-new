            ...
            >
                ...
                <div className="w-full md:w-80 flex flex-col border-l border-gray-100 bg-gray-50/30">
                    <div className="p-6 border-b border-gray-100 bg-white">
                        ...
                        <p className="text-xs text-gray-500">Mulai: {new Date(session.created_at).toLocaleString('id-ID')}</p>
                    </div>
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-6">
                        ...
                        <div className="space-y-3">
                             <div className="flex justify-between items-center py-2 border-b border-gray-100">
                                ...
                                <span className="text-xs font-medium text-gray-800">{session.user_agent ? 'Sesuai' : 'Unknown'}</span>
                             </div>
                             <div className="flex justify-between items-center py-2 border-b border-gray-100">
                                <span className="text-xs text-gray-500">IP Address</span>
                                <span className="text-xs font-medium text-gray-800">{session.ip_address || '-'}</span>
                             </div>
                        </div>
                    </div>
