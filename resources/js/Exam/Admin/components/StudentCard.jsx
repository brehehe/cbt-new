            ...
            <div className="p-3">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="flex-1 px-3 py-1.5 bg-gray-50 text-gray-700 hover:bg-gray-100 text-xs font-bold rounded-lg transition-colors border border-gray-200"
                    >
                        Detail
                    </button>
                    <button
                        onClick={() => promptSupervisorMessage(session)}
                        className="flex-1 px-3 py-1.5 bg-orange-50 text-orange-700 hover:bg-orange-100 text-xs font-bold rounded-lg transition-colors border border-orange-200 flex items-center justify-center gap-1"
