        ...
        try {
            ...
            foreach ($rows as $index => $row) {
                try {
                    ...
                    // Create user detail with lecturer specific fields
                    $detailData = [
                        'user_id' => $user->id,
                        'address' => $row['address'] ?? null,
                        'lecturer_nidn' => $row['nidnnip'] ?? null,
                        'lecturer_faculty' => $row['faculty'] ?? null,
                        'lecturer_department' => $row['department'] ?? null,
                        'lecturer_position' => $row['position'] ?? null,
                    ];
            ...
            // Log summary
            Log::info("Lecturer Import Completed", [
            ...
            Log::error("Lecturer Import Failed", $error);
            throw $th;
        }
    }
}
