...
namespace App\Livewire\Auth\Login {
    ...
    class AuthLoginIndex {
        ...
        public static function modal($name)
        {
            return \App\Livewire\Auth\Login\AuthLoginIndex::modal($name);
        }
...
namespace App\Livewire\Auth\Register {
    ...
    class AuthRegisterIndex {
        ...
        public static function modal($name)
        {
            return \App\Livewire\Auth\Register\AuthRegisterIndex::modal($name);
        }
...
namespace App\Livewire\Admin\Master\Role {
    ...
    class AdminMasterRoleIndex {
        ...
        public static function modal($name)
        {
            return \App\Livewire\Admin\Master\Role\AdminMasterRoleIndex::modal($name);
        }
...
namespace App\Livewire\Admin\Master\User {
    ...
    class AdminMasterUserIndex {
        ...
        public static function modal($name)
        {
            return \App\Livewire\Admin\Master\User\AdminMasterUserIndex::modal($name);
        }
...
namespace App\Livewire\Admin\Master\Timetable\Detail {
     ...
     *
     */
    class AdminMasterTimetableDetailIndex {
        /**
         * 
         *
         * @see \Flux\FluxManager::bootModal()
        ...
        public static function modal($name)
        {
            return \App\Livewire\Admin\Master\Timetable\Detail\AdminMasterTimetableDetailIndex::modal($name);
        }
...
namespace App\Livewire\Admin\Master\Timetable\Video {
     ...
     *
     */
    class AdminMasterTimetableVideoIndex {
        /**
         * 
         *
         * @see \Flux\FluxManager::bootModal()
        ...
        public static function modal($name)
        {
            return \App\Livewire\Admin\Master\Timetable\Video\AdminMasterTimetableVideoIndex::modal($name);
        }
...
namespace App\Livewire\Admin\Master\Timetable\Alert {
     ...
     *
     */
    class AdminMasterTimetableAlertIndex {
        /**
         * 
         *
         * @see \Flux\FluxManager::bootModal()
...
namespace App\Livewire\Admin\Master\Timetable\Answer {
     ...
     *
     */
    class AdminMasterTimetableAnswerIndex {
        /**
         * 
         *
         * @see \Flux\FluxManager::bootModal()
        ...
        public static function modal($name)
        {
            return \App\Livewire\Admin\Master\Timetable\Answer\AdminMasterTimetableAnswerIndex::modal($name);
        }
...
namespace App\Livewire\Admin\Report\Timetable {
     ...
     *
     */
    class AdminReportTimetableIndex {
        /**
         * 
         *
         * @see \Flux\FluxManager::bootModal()
        ...
        public static function modal($name)
        {
            return \App\Livewire\Admin\Report\Timetable\AdminReportTimetableIndex::modal($name);
        }
