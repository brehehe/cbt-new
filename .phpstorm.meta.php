...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Applications/DATA EWA/CBT/cbt-new/public/storage','laravel-webp.default_quality',
...
'admin.master.material-category','admin.master.rating-scale','admin.master.admin','admin.master.lecturer','admin.master.student',
'admin.master.supervisor','admin.master.timetable','admin.master.material','admin.master.question-type','admin.master.exam-type',
'admin.master.module','admin.master.question','admin.master.question.update','logout',
'storage.local',);
...
'layout.navbar','layout.sidebar','layout.warning','livewire.admin.dashboard.admin-dashboard-index','livewire.admin.exam.detail.admin-exam-detail-index',
'livewire.admin.exam.timetable.admin-exam-timetable-index','livewire.admin.exam.timetable.admin-exam-timetable-modal','livewire.admin.exam.warning.admin-exam-warning-index','livewire.admin.master.admin.admin-master-admin-index','livewire.admin.master.admin.admin-master-admin-modal',
'livewire.admin.master.exam-type.admin-master-exam-type-index','livewire.admin.master.exam-type.admin-master-exam-type-modal','livewire.admin.master.lecturer.admin-master-lecturer-index','livewire.admin.master.lecturer.admin-master-lecturer-modal','livewire.admin.master.material-category.admin-master-material-category-index',
...
'livewire.admin.master.question-type.admin-master-question-type-index','livewire.admin.master.question-type.admin-master-question-type-modal','livewire.admin.master.question.admin-master-question-index','livewire.admin.master.question.admin-master-question-modal','livewire.admin.master.question.admin-master-question-modal-update-answer',
'livewire.admin.master.question.admin-master-question-update','livewire.admin.master.rating-scale.admin-master-rating-scale-index','livewire.admin.master.rating-scale.admin-master-rating-scale-modal','livewire.admin.master.role.admin-master-role-index','livewire.admin.master.role.admin-master-role-modal',
'livewire.admin.master.setting.admin-master-setting-index','livewire.admin.master.student.admin-master-student-index','livewire.admin.master.student.admin-master-student-modal','livewire.admin.master.supervisor.admin-master-supervisor-index','livewire.admin.master.supervisor.admin-master-supervisor-modal',
'livewire.admin.master.timetable.admin-master-timetable-index','livewire.admin.master.timetable.admin-master-timetable-modal','livewire.admin.master.topic.admin-master-topic-index','livewire.admin.master.topic.admin-master-topic-modal','livewire.admin.master.user.admin-master-user-index',
'livewire.admin.master.user.admin-master-user-modal','livewire.auth.confirm-password','livewire.auth.forgot-password','livewire.auth.login','livewire.auth.login.auth-login-index',
'livewire.auth.register','livewire.auth.register.auth-register-index','livewire.auth.reset-password','livewire.auth.verify-email','livewire.settings.appearance',
...
'log-viewer::index','mail.company.company-mail','partials.head','partials.settings-heading','vendor.livewire.bootstrap',
...
'volt-livewire::admin.master.material.admin-master-material-index','volt-livewire::admin.master.material.admin-master-material-modal','volt-livewire::admin.master.module.admin-master-module-index','volt-livewire::admin.master.module.admin-master-module-modal','volt-livewire::admin.master.question-type.admin-master-question-type-index',
'volt-livewire::admin.master.question-type.admin-master-question-type-modal','volt-livewire::admin.master.question.admin-master-question-index','volt-livewire::admin.master.question.admin-master-question-modal','volt-livewire::admin.master.question.admin-master-question-modal-update-answer','volt-livewire::admin.master.question.admin-master-question-update',
'volt-livewire::admin.master.rating-scale.admin-master-rating-scale-index','volt-livewire::admin.master.rating-scale.admin-master-rating-scale-modal','volt-livewire::admin.master.role.admin-master-role-index','volt-livewire::admin.master.role.admin-master-role-modal','volt-livewire::admin.master.setting.admin-master-setting-index',
'volt-livewire::admin.master.student.admin-master-student-index','volt-livewire::admin.master.student.admin-master-student-modal','volt-livewire::admin.master.supervisor.admin-master-supervisor-index','volt-livewire::admin.master.supervisor.admin-master-supervisor-modal','volt-livewire::admin.master.timetable.admin-master-timetable-index',
'volt-livewire::admin.master.timetable.admin-master-timetable-modal','volt-livewire::admin.master.topic.admin-master-topic-index','volt-livewire::admin.master.topic.admin-master-topic-modal','volt-livewire::admin.master.user.admin-master-user-index','volt-livewire::admin.master.user.admin-master-user-modal',
...
'volt-livewire::auth.register.auth-register-index','volt-livewire::auth.reset-password','volt-livewire::auth.verify-email','volt-livewire::settings.appearance','volt-livewire::settings.delete-user-form',
...
'livewire-filepond::filepond.labelIdle','livewire-filepond::filepond.labelInvalidField','livewire-filepond::filepond.labelFileWaitingForSize','livewire-filepond::filepond.labelFileSizeNotAvailable','livewire-filepond::filepond.labelFileLoading',
'livewire-filepond::filepond.labelFileLoadError','livewire-filepond::filepond.labelFileProcessing','livewire-filepond::filepond.labelFileProcessingComplete','livewire-filepond::filepond.labelFileProcessingAborted','livewire-filepond::filepond.labelFileProcessingError',
'livewire-filepond::filepond.labelFileProcessingRevertError','livewire-filepond::filepond.labelFileRemoveError','livewire-filepond::filepond.labelTapToCancel','livewire-filepond::filepond.labelTapToRetry','livewire-filepond::filepond.labelTapToUndo',
'livewire-filepond::filepond.labelButtonRemoveItem','livewire-filepond::filepond.labelButtonAbortItemLoad','livewire-filepond::filepond.labelButtonRetryItemLoad','livewire-filepond::filepond.labelButtonAbortItemProcessing','livewire-filepond::filepond.labelButtonUndoItemProcessing',
'livewire-filepond::filepond.labelButtonRetryItemProcessing','livewire-filepond::filepond.labelButtonProcessItem','livewire-filepond::filepond.labelMaxFileSizeExceeded','livewire-filepond::filepond.labelMaxFileSize','livewire-filepond::filepond.labelMaxTotalFileSizeExceeded',
'livewire-filepond::filepond.labelMaxTotalFileSize','livewire-filepond::filepond.labelFileTypeNotAllowed','livewire-filepond::filepond.fileValidateTypeLabelExpectedTypes','livewire-filepond::filepond.imageValidateSizeLabelFormatError','livewire-filepond::filepond.imageValidateSizeLabelImageSizeTooSmall',
'livewire-filepond::filepond.imageValidateSizeLabelImageSizeTooBig','livewire-filepond::filepond.imageValidateSizeLabelExpectedMinSize','livewire-filepond::filepond.imageValidateSizeLabelExpectedMaxSize','livewire-filepond::filepond.imageValidateSizeLabelImageResolutionTooLow','livewire-filepond::filepond.imageValidateSizeLabelImageResolutionTooHigh',
'livewire-filepond::filepond.imageValidateSizeLabelExpectedMinResolution','livewire-filepond::filepond.imageValidateSizeLabelExpectedMaxResolution',);
